...
const portalLayer =
  document.getElementById("portal-visuals") || document.createElement("div");
...
document.getElementById("btn-depth-forward").addEventListener("click", () => {
  tabManager.adjustDepth(1);
});
document.getElementById("btn-depth-back").addEventListener("click", () => {
  tabManager.adjustDepth(-1);
});
